...
class StubController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans('system.entity_is_invalid', array("entity" => 'request json'));
        } elseif (!$p_response) {
            $this->_apiData['message'] = trans('system.entity_is_invalid', array("entity" => 'response json'));
        } else {
            // success response
