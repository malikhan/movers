...
//			'role_id' => 'required|int|exists:' . $ex2Model->table . "," . $ex2Model->primaryKey . ",deleted_at,NULL",
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans('system.entity_already_exists', array("entity" => $this->_entity_ucfirst));
        } else {
...
//            $this->_apiData['message'] = trans('system.your_account_is_activated');
    ...
    public function signin(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            //$this->_apiData['kick_user'] = 1;
            // message
            $this->_apiData['message'] = trans('system.your_account_is_baned_removed', array("entity" => "baned or removed"));
        } else {
            // success response
            $this->_apiData['response'] = "success";
    ...
    {    // trim/escape all
        ...
        if ($validator->fails()) {
            ...
            $this->_apiData['message'] = trans('system.pls_enter_entity_id', array("entity" => $this->_object_identifier));
        }else if($entity==""){
